...
import com.example.uts.DaftarTemanFragment;
import com.example.uts.sql.DbHelper;

/**
 * Tanggan Pengerjaan : 9 Agustus 2019
 * NIM : 10116163
...
public class FormInput extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        id = getIntent().getStringExtra(DaftarTemanFragment.TAG_ID);
        nim = getIntent().getStringExtra(DaftarTemanFragment.TAG_NIM);
        nama = getIntent().getStringExtra(DaftarTemanFragment.TAG_NAMA);
        kelas = getIntent().getStringExtra(DaftarTemanFragment.TAG_KELAS);
        telp = getIntent().getStringExtra(DaftarTemanFragment.TAG_TELP);
        email = getIntent().getStringExtra(DaftarTemanFragment.TAG_EMAIL);
        instagram = getIntent().getStringExtra(DaftarTemanFragment.TAG_INSTAGRAM);
